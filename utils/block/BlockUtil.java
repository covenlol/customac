...
public class BlockUtil {
    ...
    public static Block getBlock(WrappedInBlockPlacePacket packet, User user) {
        return getBlock(packet.getBlockPosition().toBukkitVector().toLocation(user.getPlayer().getWorld()));
    }
